...
Section Exercise_5_1_1_9.
  ...
  (** [p] is the functor which sends every category to its set of
      connected components, where a connected component is an
      equivalence class defined by the equivalence relation [a ~ b]
      generated by the existence of morphisms; if there is a morphism
      [a -> b], then [a ~ b]. *)
